    ...
    public static PKM GetLegalFromTemplate(this ITrainerInfo dest, PKM template, IBattleTemplate set, out LegalizationResult satisfied, IEncounterable? ogenc = null)
    {
        ...
        foreach (var enc in encounters)
        {
            ...
            if (enc is EncounterTrade8b { Species: (ushort)Species.Magikarp })
            {
                ...
                {
                    "ポッちゃん" => BlankSaveFile.Get(tr.Context, tr.OT, LanguageID.Japanese),
                    "Bloupi" => BlankSaveFile.Get(tr.Context, tr.OT, LanguageID.French),
                    "Mossy" => BlankSaveFile.Get(tr.Context, tr.OT, LanguageID.Italian),
                    "Pador" => BlankSaveFile.Get(tr.Context, tr.OT, LanguageID.German),
                    _ => BlankSaveFile.Get(tr.Context, tr.OT, LanguageID.English),
                };
